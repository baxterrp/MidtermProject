...
public class testStore {
	public static void main(String[] args) {
		...
		do {
			System.out
					.print("What would you like to do? Add item / Purchase item");
					...
					if (Character.toLowerCase(option2.charAt(0)) == 'o') {
						...
						for (String[] s : products) {
							if (s[0].equals(option2)) {
								...
								BigDecimal bd = new BigDecimal(cost).setScale(
			...
			System.out.println("Start App Over?");
			runApp = scan.nextLine();
		} while (Character.toLowerCase(runApp.charAt(0)) == 'y');
